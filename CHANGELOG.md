...
## [4.0.0](https://github.com/rknightion/genai-otel-bridge/compare/v3.0.1...v4.0.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* genai_otel_bridge_source_graph_unavailable_total is retired; use genai_otel_bridge_source_capability_total and genai_otel_bridge_source_data_incomplete_total.
...
* **chart:** add Artifact Hub metadata and point home at the docs site ([8e721fd](https://github.com/rknightion/genai-otel-bridge/commit/8e721fd43e05d5d2738e5037d4928ae882201e59))
...
* **docs:** take the fleet project icon for the site logo and favicon ([1656254](https://github.com/rknightion/genai-otel-bridge/commit/16562543ca8f2307cb5cbb9ff9e36d51460c22fc))
* **docs:** take the fleet-generated social card ([45c97b9](https://github.com/rknightion/genai-otel-bridge/commit/45c97b9c19ffef05398efeb16d82f472d500f4e5))
* emit native self-observability histograms ([35b2dfb](https://github.com/rknightion/genai-otel-bridge/commit/35b2dfba437053b85c981c0e22f0ea8965e6c0e8))
...
* mint release-please token from the OpenBao broker ([25413e3](https://github.com/rknightion/genai-otel-bridge/commit/25413e365f2e2b0f21358f1807727a0e5bebe652))
* mint the docs-sync token from the OpenBao broker ([8ce848f](https://github.com/rknightion/genai-otel-bridge/commit/8ce848f5e1b97531767ab2f0d6bc77a7c29cadb9))
* relicense from AGPL-3.0-only to Apache-2.0 ([bfd95f4](https://github.com/rknightion/genai-otel-bridge/commit/bfd95f4237392a2fb75f67e7d2cb6af0bb8186dc))
* split source capability and incomplete-data metrics ([90f96ef](https://github.com/rknightion/genai-otel-bridge/commit/90f96ef5e17150646b9e8f63c40d2ba58189f786))
...
* trace and measure emit processing ([dbf5e4f](https://github.com/rknightion/genai-otel-bridge/commit/dbf5e4f2c1b9ddea6b5a5153d2de0c8ba6f7b4d2))
* trace checkpoint commit outcomes ([6d71243](https://github.com/rknightion/genai-otel-bridge/commit/6d712435c3c9996cb82b9c598b92577c80c82ac5))
* trace Portkey export lifecycle ([c6e822f](https://github.com/rknightion/genai-otel-bridge/commit/c6e822fe742f9f4878b04abab8a8f8eae1fea5c8))
...
* author is Rob Knight, not Rob Knighton ([28ce9da](https://github.com/rknightion/genai-otel-bridge/commit/28ce9da4d541692a1a15823aa159adedafa7d8d7))
...
* **changelog:** demote the duplicate mid-file Changelog heading ([fcdef67](https://github.com/rknightion/genai-otel-bridge/commit/fcdef674b76af167a74d7f1c26d113f9713d87da))
...
* **deps:** update go modules (non-major) ([#181](https://github.com/rknightion/genai-otel-bridge/issues/181)) ([3dbf7ce](https://github.com/rknightion/genai-otel-bridge/commit/3dbf7cef28f69b8c546f84b60777572fe31d884c))
* **deps:** update go modules (non-major) ([#182](https://github.com/rknightion/genai-otel-bridge/issues/182)) ([4bd6741](https://github.com/rknightion/genai-otel-bridge/commit/4bd67410334142d56ceb3e5a734b96f4e839d373))
* **deps:** update go modules (non-major) ([#184](https://github.com/rknightion/genai-otel-bridge/issues/184)) ([22a3271](https://github.com/rknightion/genai-otel-bridge/commit/22a32713984da4c238ffe908d1a4553ae9bc9dbc))
* **deps:** update go modules (non-major) ([#190](https://github.com/rknightion/genai-otel-bridge/issues/190)) ([fd21361](https://github.com/rknightion/genai-otel-bridge/commit/fd21361a663826bc8bde61cb05991d19f3b4566e))
* **deps:** update go modules (non-major) ([#193](https://github.com/rknightion/genai-otel-bridge/issues/193)) ([f0edcd2](https://github.com/rknightion/genai-otel-bridge/commit/f0edcd2d9f8ee00102ed05a602786133e48d8b94))
* **deps:** update go modules (non-major) ([#197](https://github.com/rknightion/genai-otel-bridge/issues/197)) ([a293ad1](https://github.com/rknightion/genai-otel-bridge/commit/a293ad1ae865ff5d31f4a75346ff7275f63689e1))
* **deps:** update go modules (non-major) ([#204](https://github.com/rknightion/genai-otel-bridge/issues/204)) ([e12432d](https://github.com/rknightion/genai-otel-bridge/commit/e12432d10cfbcc77bc48e927fbf17e7c4b4d9dfa))
* **deps:** update go modules (non-major) ([#206](https://github.com/rknightion/genai-otel-bridge/issues/206)) ([8c3bac1](https://github.com/rknightion/genai-otel-bridge/commit/8c3bac104ceb6864fa1df62a9ffc09a232a73877))
* **deps:** update go modules (non-major) ([#209](https://github.com/rknightion/genai-otel-bridge/issues/209)) ([23db074](https://github.com/rknightion/genai-otel-bridge/commit/23db0749998f30df11c483a883725d0a677051d7))
* **deps:** update go modules (non-major) ([#212](https://github.com/rknightion/genai-otel-bridge/issues/212)) ([aa087df](https://github.com/rknightion/genai-otel-bridge/commit/aa087df3168acd5450372af9d10a7156fa6978be))
* **deps:** update go modules (non-major) ([#214](https://github.com/rknightion/genai-otel-bridge/issues/214)) ([09c668f](https://github.com/rknightion/genai-otel-bridge/commit/09c668f9e76f5fb714fd1cb93608812b30b789fe))
...
* **deps:** update go modules (non-major) ([#228](https://github.com/rknightion/genai-otel-bridge/issues/228)) ([f04a9eb](https://github.com/rknightion/genai-otel-bridge/commit/f04a9eb088d86ca8a6c653044d5c2ca4a9f90412))
* **deps:** update go modules (non-major) ([#235](https://github.com/rknightion/genai-otel-bridge/issues/235)) ([f0974a6](https://github.com/rknightion/genai-otel-bridge/commit/f0974a60c6dc66a1a08110c9dcd4bae6e919c52c))
* **deps:** update go modules (non-major) ([#239](https://github.com/rknightion/genai-otel-bridge/issues/239)) ([bcea465](https://github.com/rknightion/genai-otel-bridge/commit/bcea465bef600e88f25b2bb5d24b2eb864f730d1))
* **deps:** update go modules (non-major) ([#250](https://github.com/rknightion/genai-otel-bridge/issues/250)) ([890351d](https://github.com/rknightion/genai-otel-bridge/commit/890351d4e819225ec11ab0b481ded630a9304621))
...
* **deps:** update kubernetes libraries to v0.36.4 ([#201](https://github.com/rknightion/genai-otel-bridge/issues/201)) ([8c0a1c4](https://github.com/rknightion/genai-otel-bridge/commit/8c0a1c48fb4fec046c618cf92bd2e2fe2bed381a))
* **deps:** update kubernetes libraries to v0.37.0 ([#208](https://github.com/rknightion/genai-otel-bridge/issues/208)) ([d43c38c](https://github.com/rknightion/genai-otel-bridge/commit/d43c38c96a758769f7a2e41988b5333a1f77667e))
* **deps:** update kubernetes libraries to v0.37.1 ([#248](https://github.com/rknightion/genai-otel-bridge/issues/248)) ([fc09ced](https://github.com/rknightion/genai-otel-bridge/commit/fc09ced898dd1084d76b96c05880646ada058f89))
* **deps:** update module github.com/aws/aws-sdk-go-v2/service/dynamodb to v1.62.0 ([#178](https://github.com/rknightion/genai-otel-bridge/issues/178)) ([2b6964c](https://github.com/rknightion/genai-otel-bridge/commit/2b6964cc32792e024b36d036e587034303db8098))
* **deps:** update module github.com/aws/aws-sdk-go-v2/service/dynamodb to v1.63.0 ([#187](https://github.com/rknightion/genai-otel-bridge/issues/187)) ([c647eb7](https://github.com/rknightion/genai-otel-bridge/commit/c647eb77745709b04cf56c4533d7dffd92593aa1))
* **deps:** update module github.com/aws/aws-sdk-go-v2/service/dynamodb to v1.69.0 ([#240](https://github.com/rknightion/genai-otel-bridge/issues/240)) ([b1fec6b](https://github.com/rknightion/genai-otel-bridge/commit/b1fec6b8dc36fa2bfb596f94a8476b58c490951d))
...
* **deps:** update module github.com/grafana/pyroscope-go to v1.4.2 ([#194](https://github.com/rknightion/genai-otel-bridge/issues/194)) ([c60a36e](https://github.com/rknightion/genai-otel-bridge/commit/c60a36eaccca7da6c31cff5a06738a636e3d8f02))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.70.0 ([#186](https://github.com/rknightion/genai-otel-bridge/issues/186)) ([592764c](https://github.com/rknightion/genai-otel-bridge/commit/592764cb544b22d7c4affb13e51f3f50acc01ee5))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.71.0 ([#207](https://github.com/rknightion/genai-otel-bridge/issues/207)) ([5f4d613](https://github.com/rknightion/genai-otel-bridge/commit/5f4d613056617d22df830c0b17e14e99149b44e0))
...
* **deps:** update module golang.org/x/time to v0.16.0 ([#233](https://github.com/rknightion/genai-otel-bridge/issues/233)) ([f366dc6](https://github.com/rknightion/genai-otel-bridge/commit/f366dc6fe9d25bd59bd2992e1e8dd0ca1388ff54))
* **deps:** update module google.golang.org/protobuf to v1.36.12 ([#191](https://github.com/rknightion/genai-otel-bridge/issues/191)) ([b55b187](https://github.com/rknightion/genai-otel-bridge/commit/b55b187816e6d0567b60869d84f670f5fbc5c542))
...
* **deps:** update module k8s.io/client-go to v0.36.4 ([#202](https://github.com/rknightion/genai-otel-bridge/issues/202)) ([3a83d90](https://github.com/rknightion/genai-otel-bridge/commit/3a83d90b38bff250f0dedbda54aa8978168883d2))
* **deps:** update module sigs.k8s.io/controller-runtime to v0.25.0 ([#231](https://github.com/rknightion/genai-otel-bridge/issues/231)) ([7118d28](https://github.com/rknightion/genai-otel-bridge/commit/7118d28978d721e31aa9d90bb078c3563476d178))
* **deps:** update module sigs.k8s.io/controller-runtime to v0.25.1 ([#237](https://github.com/rknightion/genai-otel-bridge/issues/237)) ([52149d7](https://github.com/rknightion/genai-otel-bridge/commit/52149d7b90e18cd746aa053d903c195a308f5535))
* **deps:** update opentelemetry to v1.45.0 ([#185](https://github.com/rknightion/genai-otel-bridge/issues/185)) ([b10fc28](https://github.com/rknightion/genai-otel-bridge/commit/b10fc28c6388c0c69daf736d8544290e6b1ca2b9))
* **deps:** update opentelemetry to v1.46.0 ([#205](https://github.com/rknightion/genai-otel-bridge/issues/205)) ([8bbea60](https://github.com/rknightion/genai-otel-bridge/commit/8bbea60b8c2c9544410181514f14792876883068))
...
* **helm:** give kubeconform the CRD schemas for ExternalSecret + SecretStore ([dcfb24f](https://github.com/rknightion/genai-otel-bridge/commit/dcfb24fbd91b9789fcb7cc6e930649c9a40ef617))
* **helm:** restore the doubled braces in the CRD schema URL ([ea6bf52](https://github.com/rknightion/genai-otel-bridge/commit/ea6bf52de35aab66275253e98b197ac4f9941642))
...
* **notices:** use the /v2 module path for go-licenses ([262acb5](https://github.com/rknightion/genai-otel-bridge/commit/262acb55016a0a3ded26d12038ba9bb4f1aef737))
* pass the JWT role explicitly for docs-sync ([8e587eb](https://github.com/rknightion/genai-otel-bridge/commit/8e587eb00f3ef68a2fa1c614ccb1dfc90aec39f3))
...
* repair third-party notices generation ([3451473](https://github.com/rknightion/genai-otel-bridge/commit/3451473571206df2bb4a51da088973f9bef7f805))
...
* add a "Why This Bridge" positioning page ([b240ec0](https://github.com/rknightion/genai-otel-bridge/commit/b240ec0a337995d1a8cf031cafa1284448114fd4))
* add an FAQ ([d3fa3f7](https://github.com/rknightion/genai-otel-bridge/commit/d3fa3f707864dcd6d801578fb7b827ecf4036fd2))
* adopt canonical routing and bounded root rescue ([5466f5e](https://github.com/rknightion/genai-otel-bridge/commit/5466f5eceb25044825c8008d6e47a426d8a9e798))
* adopt the m7kni.io inverted docs model ([fb09f70](https://github.com/rknightion/genai-otel-bridge/commit/fb09f706b85d0283c19bc80c34a81eae7e9c6c4a))
* **agents:** cmd/genai-otel-bridge to AGENTS.md standard ([e710385](https://github.com/rknightion/genai-otel-bridge/commit/e710385f0f51eb94308fddf7f57f211dd93ab38a))
* **agents:** deploy to AGENTS.md standard ([4cdd818](https://github.com/rknightion/genai-otel-bridge/commit/4cdd818a6187846eafc9ff515a4f2b425c2fa344))
* **agents:** internal/app to AGENTS.md standard ([00a021f](https://github.com/rknightion/genai-otel-bridge/commit/00a021f06d14c2a7f9ea5e6d823fbe57772725e9))
* **agents:** internal/checkpoint to AGENTS.md standard ([7b3fe3c](https://github.com/rknightion/genai-otel-bridge/commit/7b3fe3c33fc5e5c8f6afce6a904c4f7683ad2dcd))
* **agents:** internal/config to AGENTS.md standard ([0597a7c](https://github.com/rknightion/genai-otel-bridge/commit/0597a7cf56b93ac7d4b3c7ec2e533e57b6a523f2))
* **agents:** internal/coordinate to AGENTS.md standard ([80b83a9](https://github.com/rknightion/genai-otel-bridge/commit/80b83a9961d7f01b7a741b0913a8b81688f73454))
* **agents:** internal/emit to AGENTS.md standard ([b3af6bd](https://github.com/rknightion/genai-otel-bridge/commit/b3af6bd22dd25cb94f89cda2e8048f6f172d1eed))
* **agents:** internal/httpx to AGENTS.md standard ([a3ce514](https://github.com/rknightion/genai-otel-bridge/commit/a3ce514547a70024ad40016bbe5e625bb7e54f33))
* **agents:** internal/model to AGENTS.md standard ([7e6ca46](https://github.com/rknightion/genai-otel-bridge/commit/7e6ca46f5f91c92e057591de247458808df390c7))
* **agents:** internal/schedule to AGENTS.md standard ([f5a4dd9](https://github.com/rknightion/genai-otel-bridge/commit/f5a4dd9484148e43ab1baa008485106003fb6d88))
* **agents:** internal/selfobs to AGENTS.md standard ([6621d27](https://github.com/rknightion/genai-otel-bridge/commit/6621d27e0748862fe94ac7a7792abceca2970716))
* **agents:** internal/source to AGENTS.md standard ([a2974ad](https://github.com/rknightion/genai-otel-bridge/commit/a2974adc604b56cef8c5bdc617d16e2c6ee3da59))
* **agents:** internal/source/langsmith to AGENTS.md standard ([811442e](https://github.com/rknightion/genai-otel-bridge/commit/811442e5373fbd973e0f4041d9a36bb7f65dea16))
* **agents:** internal/source/portkey to AGENTS.md standard ([20f1b89](https://github.com/rknightion/genai-otel-bridge/commit/20f1b89b959ed9f44df5c2a5e1c1744aa545c7ac))
* **agents:** repo root to AGENTS.md standard ([599a711](https://github.com/rknightion/genai-otel-bridge/commit/599a7110c36fe53e6350642c43ac63b8195b09b9))
* **agents:** review fix - cmd heading count and a history-shaped clause ([4b2ade5](https://github.com/rknightion/genai-otel-bridge/commit/4b2ade562407b914a6c308a60837781894b8d6c5))
* **agents:** review fix - name the governance.max_dpm key in internal/schedule ([ce19226](https://github.com/rknightion/genai-otel-bridge/commit/ce1922670deb34bb25b8ee3386c2ef49285545c3))
* **agents:** review fix - restore five portkey identifiers and traps ([dac0265](https://github.com/rknightion/genai-otel-bridge/commit/dac0265f26182ed3248f25b28f0138cb4b3744d7))
* **agents:** review fix - restore four langsmith facts dropped by the lane ([a940fb4](https://github.com/rknightion/genai-otel-bridge/commit/a940fb4d627769b07ac07de0dc684ceae76a7e2c))
* **agents:** review fix - restore internal/selfobs profiling and observer seams ([f18c976](https://github.com/rknightion/genai-otel-bridge/commit/f18c976ae7eff7f8f66e97f3b3dada3a815a386b))
* **agents:** review fix - restore the bare --notes/--plan backlog trap ([19f39d8](https://github.com/rknightion/genai-otel-bridge/commit/19f39d843e5ed1a6c0413905da4837a028594324))
* **agents:** review fix - restore the empty-AllowHosts default-allow trap ([1a43c16](https://github.com/rknightion/genai-otel-bridge/commit/1a43c16358ed503c1676ded803def05730a8ad8e))
* **agents:** review fix - restore the internal/emit partial-success identifiers ([0cf441e](https://github.com/rknightion/genai-otel-bridge/commit/0cf441e12badc7614750303b3ee18e8817f9701b))
* **agents:** review fix - restore the internal/source budget-zero trap and Deps hooks ([0ce9a72](https://github.com/rknightion/genai-otel-bridge/commit/0ce9a725039cef6603e09635f89429642518074c))
* **agents:** review fix - restore three internal/config identifiers ([35d4691](https://github.com/rknightion/genai-otel-bridge/commit/35d4691afe0b55da5edf1c6a7be6832b1f668ba6))
* **agents:** review fix - restore three internal/model wire-format facts ([98dd6ef](https://github.com/rknightion/genai-otel-bridge/commit/98dd6efd543176d73cdffee5d2cfb75dbb7fe9b4))
* **agents:** review fix - restore two internal/checkpoint durability invariants ([56363ee](https://github.com/rknightion/genai-otel-bridge/commit/56363ee933b8069577551806e782eec51c12fa25))
* **agents:** review fix - restore two internal/coordinate traps ([a93295f](https://github.com/rknightion/genai-otel-bridge/commit/a93295f6ae3451ec8f6f9e5d1b8bf359093bb369))
* **agents:** review fix - state the internal/app denylist trap in present tense ([73a29fc](https://github.com/rknightion/genai-otel-bridge/commit/73a29fca1790dca1055f048ff75149a2d09af454))
* align recovery contracts and compaction evidence ([b64866b](https://github.com/rknightion/genai-otel-bridge/commit/b64866be9049075fd44cd1ee28a7de022409f49e))
...
* **backlog:** complete Go 1.27 upgrade ([faf09a4](https://github.com/rknightion/genai-otel-bridge/commit/faf09a4c4f2838704ca8aa64a1d814386cf01764))
* **backlog:** sync fan-out protocol — CodeRabbit review gate ([0169d5c](https://github.com/rknightion/genai-otel-bridge/commit/0169d5c6f0fafcc0c0f6d07026b8a91a5b1dfaf6))
* **backlog:** sync fan-out protocol — success criteria vs write authority ([8bbf24a](https://github.com/rknightion/genai-otel-bridge/commit/8bbf24aa4adaffdcbd52203e3dce014572bacfbc))
...
* document native histogram aggregation ([ace1329](https://github.com/rknightion/genai-otel-bridge/commit/ace1329b4bb6c65a6e30b56127f1a90f3f5aac4a))
* document proxy DNS rebinding residual ([db23fbc](https://github.com/rknightion/genai-otel-bridge/commit/db23fbcbd8bcca74dc7276cf9cfe210c0a055e5a))
* drop the unused MathJax and ES6 polyfill CDN scripts ([7bb7e98](https://github.com/rknightion/genai-otel-bridge/commit/7bb7e98d5c1613f10f75f105efb747add406aad5))
...
* improve search result descriptions ([c09b76f](https://github.com/rknightion/genai-otel-bridge/commit/c09b76f006add2dab76139d1f1aed5fdee71aa69))
* publish canonical agent documents ([b9bf2f9](https://github.com/rknightion/genai-otel-bridge/commit/b9bf2f90116720a52298485f46fff7b4dc4cd918))
* publish canonical agent documents ([f77d241](https://github.com/rknightion/genai-otel-bridge/commit/f77d241a53324996d589f920575ebf1c426cef8c))
* publish canonical agent documents ([67ecac3](https://github.com/rknightion/genai-otel-bridge/commit/67ecac39b8023e69e47ad8ef814d07425a920a01))
* publish canonical agent documents ([72fb02b](https://github.com/rknightion/genai-otel-bridge/commit/72fb02be7d996c06521e02eeda5bebfbd3d8c607))
* publish canonical agent documents ([4b1dc3c](https://github.com/rknightion/genai-otel-bridge/commit/4b1dc3c6b3a163da81217b04e101b42d142376c0))
* publish canonical agent documents ([9d72109](https://github.com/rknightion/genai-otel-bridge/commit/9d72109a92cd13096d3348ce854660decc932dda))
* publish canonical agent documents ([aa6bd9d](https://github.com/rknightion/genai-otel-bridge/commit/aa6bd9d194339f3a07a9c3bbfbd9a3a7b8991cb4))
* publish canonical agent documents ([fb0dd92](https://github.com/rknightion/genai-otel-bridge/commit/fb0dd92993d06650a88be960f3bf8f3e89dfeb4e))
* publish canonical agent documents ([ab552e2](https://github.com/rknightion/genai-otel-bridge/commit/ab552e20d138b56ca3aed4a9fff1ee81cbaabc3a))
* publish canonical agent documents ([373fa3e](https://github.com/rknightion/genai-otel-bridge/commit/373fa3ea2f9b853ffd01ebdbe0b0f11115b50f4a))
* publish canonical agent documents ([d73aeea](https://github.com/rknightion/genai-otel-bridge/commit/d73aeea04f4147720adbcf017e7891e856d2dc9f))
* publish canonical agent documents ([306615e](https://github.com/rknightion/genai-otel-bridge/commit/306615e75467de8ecb605567fc36a17e2a04b666))
* publish canonical agent documents ([a86961e](https://github.com/rknightion/genai-otel-bridge/commit/a86961eb54b9475f577995d95ef9c7c896b45f3e))
* publish canonical agent documents ([cdc93d8](https://github.com/rknightion/genai-otel-bridge/commit/cdc93d8908ba73a184783de6d8f62828af14c9b6))
* publish canonical agent documents ([8037495](https://github.com/rknightion/genai-otel-bridge/commit/80374958533bd9d5667c0bec7dc023f61b53e523))
* publish canonical agent documents ([4e163a4](https://github.com/rknightion/genai-otel-bridge/commit/4e163a49822943a1de9f63c3c80beb5bb4e09979))
* publish canonical agent documents ([785833f](https://github.com/rknightion/genai-otel-bridge/commit/785833f628cec28059e7879a73b8a730ab16f0bc))
* publish public Backlog workspace ([9eacd14](https://github.com/rknightion/genai-otel-bridge/commit/9eacd14e2ca80bd779f5a0ffd922f31b2b77e2d8))
* re-import fan-out protocol (context-cost rules) ([c87452f](https://github.com/rknightion/genai-otel-bridge/commit/c87452f94e0b7018cda720c4c0d815c26ad49170))
* re-import the fan-out protocol at c1e6cb0 ([089f06d](https://github.com/rknightion/genai-otel-bridge/commit/089f06d6bea0b67958b81a74e8be9127cef5e72c))
* re-render the fan-out protocol from agent-docs ([af2fe7a](https://github.com/rknightion/genai-otel-bridge/commit/af2fe7a785b0058a5cc796f0c7f363be454bf27e))
* re-render the fan-out protocol from agent-docs 711db6c ([b9a5b78](https://github.com/rknightion/genai-otel-bridge/commit/b9a5b783897ded4fb163ffa985577456bb94b854))
* re-render the fan-out protocol from agent-docs b0d76d8 ([9bff53c](https://github.com/rknightion/genai-otel-bridge/commit/9bff53c6f2a6be52ea78d0a73d2c647189c72ef7))
* **readme:** lead with what the project is ([07c2973](https://github.com/rknightion/genai-otel-bridge/commit/07c2973b6984aeb859e8ea6ff811420ae3d2de6f))
* reconcile observability design records ([a57fcca](https://github.com/rknightion/genai-otel-bridge/commit/a57fcca06766c6a7c572a0da1b4353dd498ac70c))
* record self-APM span coverage ([25dce38](https://github.com/rknightion/genai-otel-bridge/commit/25dce388af4aadaa4927053780aef85def5b1bd0))
* record that [#165](https://github.com/rknightion/genai-otel-bridge/issues/165) was deleted too, not just the closed set ([6c699d4](https://github.com/rknightion/genai-otel-bridge/commit/6c699d40415561057f13b3de4c95b1ef33e23dac))
* remove stale wiring comments ([200bc97](https://github.com/rknightion/genai-otel-bridge/commit/200bc9737e20bfe5967c4e4a8bf979d889ef1e05))
...
* sync agent-docs, a wave's launch message is a file not a chat block ([ed61986](https://github.com/rknightion/genai-otel-bridge/commit/ed619869977f472df83ea5554967f4f56e1eed06))
* sync approved fan-out scheduling and route verification ([f5b20ae](https://github.com/rknightion/genai-otel-bridge/commit/f5b20ae07844896d8e5b6d9c68fb869a50912a32))
* sync Astra routing and default wave reports to files ([180877e](https://github.com/rknightion/genai-otel-bridge/commit/180877ed3b9115e4fe6b786a4c3e2ee4b01dc8c0))
* sync authorised Astra root judgement ([734c529](https://github.com/rknightion/genai-otel-bridge/commit/734c529141befc5ce3be5507aa24f14062f58733))
* sync authorised Astra root judgement ([938fe57](https://github.com/rknightion/genai-otel-bridge/commit/938fe573fe1749bce143e17fc6ca6b21cf054cf8))
* sync cost-aware fan-out routing and prompt guidance ([59c572e](https://github.com/rknightion/genai-otel-bridge/commit/59c572e5901c1a58cbb0c796e40a53ac48ebddea))
* sync fan-out async decision-only guidance ([14faaf7](https://github.com/rknightion/genai-otel-bridge/commit/14faaf74b71364a9fc37475260668e3bb78a4ae6))
* sync fan-out protocol from agent-docs ad7abd2 ([7b0f1f6](https://github.com/rknightion/genai-otel-bridge/commit/7b0f1f6c3d51c7f33248af6ae6473473507e26d8))
* sync fan-out protocol, delegated root authority for unattended runs ([085a11b](https://github.com/rknightion/genai-otel-bridge/commit/085a11bd4bc3e0b775c71c9faeaf504fc211db6c))
* sync fan-out protocol, explicit add does not bound the commit ([8c8c625](https://github.com/rknightion/genai-otel-bridge/commit/8c8c6250ada5c07e917bf352827fe5146ede3f28))
* sync fixed Astra low orchestration and rescue routing ([5ea0fa5](https://github.com/rknightion/genai-otel-bridge/commit/5ea0fa5c11d2ab950538113bb08eec8e9397acf0))
* sync nineteen-worker Codex fan-out guidance ([fcd4303](https://github.com/rknightion/genai-otel-bridge/commit/fcd4303b6b83cd759846375b3a1a21e015154f02))
* sync optional Astra fan-out routing and run contracts ([dfa09c3](https://github.com/rknightion/genai-otel-bridge/commit/dfa09c309c337f845f9da8203ca3e675b1d88612))
* sync polling and integration contracts ([b49031b](https://github.com/rknightion/genai-otel-bridge/commit/b49031b94f6904f338c6a2fd4f0263d5f866098f))
* sync root async question policy ([80dba3b](https://github.com/rknightion/genai-otel-bridge/commit/80dba3bb20da5d44e55015541a7dc9d0f47259be))
* sync same-session fan-out recovery contract ([80e427c](https://github.com/rknightion/genai-otel-bridge/commit/80e427c3307c1b8aa5bd1565bd5ccca9a19c057c))
* sync wave orchestration and existing-root contracts ([7f142a9](https://github.com/rknightion/genai-otel-bridge/commit/7f142a9841c7c8b70b557839b98be3cde6ff8a47))
* sync wave reliability and worktree contracts ([6401407](https://github.com/rknightion/genai-otel-bridge/commit/64014073065665cdf9b37a7778673a316b68d9f1))
* sync wave-root stage authority and lab-Mac GUI gate ([dc027ae](https://github.com/rknightion/genai-otel-bridge/commit/dc027ae3e25ea4ec4367e1501d2bb519f7fb4b81))
* **tracker:** align canonical fan-out protocol ([ae2b167](https://github.com/rknightion/genai-otel-bridge/commit/ae2b167783a9f799ea199c683006aa5b1d9cb4fb))
* **tracker:** correct the canonical owner in the rendered header ([0d417b2](https://github.com/rknightion/genai-otel-bridge/commit/0d417b24a8dde544c84d586a856107798abcc037))
* **tracker:** re-import the fan-out protocol from canonical ([414d743](https://github.com/rknightion/genai-otel-bridge/commit/414d7436c83b0aa060e1b1dd263fe045cc0f87bf))
* **tracker:** render agent documents from the canonical source ([88f1beb](https://github.com/rknightion/genai-otel-bridge/commit/88f1bebe3815b9bf3e2aaa3cad36218902919a19))
...
* add auto-rc, arm-automerge and ghcr-cleanup ([64467f0](https://github.com/rknightion/genai-otel-bridge/commit/64467f08eb2e4060fab6152c67acbfcf62919a2c))
...
* **auto-rc:** trigger on CI completion instead of push ([4f8f795](https://github.com/rknightion/genai-otel-bridge/commit/4f8f795ac63a0515e9eb75631c4a88b1a1d2f5ce))
...
* bump the broker-token action pin ([7567fb6](https://github.com/rknightion/genai-otel-bridge/commit/7567fb69e94495a007ca3a2ea75479783584e265))
...
* docs-sync and grafana-sync targets moved to the m7kni org ([e8cacf2](https://github.com/rknightion/genai-otel-bridge/commit/e8cacf20c6d45f194b95c4421d7c0203b577959b))
...
* **helm:** validate the rendered chart against the Kubernetes API schemas ([64eb9ac](https://github.com/rknightion/genai-otel-bridge/commit/64eb9ac472872004c886875d9d886f5714192679))
...
* repin the release-automation reusables to v1.8.0 ([888876c](https://github.com/rknightion/genai-otel-bridge/commit/888876c5eb99756e28bd4160081f70f396cdfbb8))
* repin the shared reusables to v1.18.1 ([7a63147](https://github.com/rknightion/genai-otel-bridge/commit/7a63147252df35e50d26fb7200d3048cd520cc3e))
...
* tune ci.yml — CI concurrency hygiene ([1ed5129](https://github.com/rknightion/genai-otel-bridge/commit/1ed51291be62716c93b9574c06302752ddb580aa))
* upgrade to Go 1.27 ([f1ab1a3](https://github.com/rknightion/genai-otel-bridge/commit/f1ab1a3ff24683cd179ceae7fbd951a69067ebbb))
