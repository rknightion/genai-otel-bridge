...
FROM --platform=$BUILDPLATFORM mirror.gcr.io/library/golang:1.27.0-bookworm@sha256:484ef6066fa69acb059fdfeda7ba2b8f7391f2ef6abc6f9b8411e669ebd56466 AS builder
WORKDIR /build
COPY go.mod go.sum ./
