...
type: specification
created_date: '2026-08-14 16:03'
updated_date: '2026-08-14 16:04'
---
> **Imported verbatim from `/Users/rob/repos/agent-fanout-generic.md` on 2026-08-14.** This copy is
> authoritative for `genai-otel-bridge`: an agent with only this checkout has the whole model, and
> the source is a loose unversioned file on one machine. It is **not** summarised, compressed or
> adapted — when the source changes, re-import it here in the same change. Everything below this
> line is the source, byte-for-byte.
